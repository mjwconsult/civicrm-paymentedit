...
{if $form.payment_processor_id.value}
  <div class="warning">As this payment is linked to a payment processor any changes you make here may have unexpected results.</div>
{/if}
